...
@section('content')
<div class="container">
    <table id="requestlist" class="display text-center table-striped table-bordered dt-responsive nowrap text-center" cellspacing="0" style="width:100%;margin-top:10px;background-color:ghostwhite">
