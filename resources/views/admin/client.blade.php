                        ...
                        columns: [
                            ...
                            { data: 'updated_at'},
                            {
                                'render' : function (data, type, full, meta){             
                                    data = '<button id="btn-client-view" type="button" onclick="getClient('+full['id']+');" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#addModal" class="btn btn-link btn-sm" >View</button>||<button id="btn-client-delete" type="button" onclick="deleteClient('+full['id']+');" class="btn btn-link btn-sm" >Delete</button>'
                                    return data;
                                }
                            }
                        ]
...
$(document).ready(function(){
    ...
    $('#form-add-client').submit(function(e){
        e.preventDefault();
		$.ajax({
	        url: "/admin/client/add/" + $('#btn-client-add').attr('data-client-id'),
            type: "POST",
